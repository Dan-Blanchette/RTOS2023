...
For future projects with FreeRTOS, you should be able to use the CMakeLists.txt file as a guide. Make sure your PICO_SDK_FREERTOS_SOURCE file has the correct filepath. cd
